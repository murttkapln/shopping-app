  ...
  return (
...

    {
      ...
      products.map((item,{id})=>{
        ...
        <div key={id}  className="max-w-sm flex flex-wrap justify-center items-center bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
